...
<section class="pattern-detail pattern-detail--seq">
    <div class="pattern-detail__image">
        <img src="../../image/pattern/qing-binglie-jingdezhen-guanyao.jpg" alt="冰裂纹" />
    </div>
    <div class="pattern-detail__content">
        ...
        <article class="pattern-detail__info">
            ...
            <div class="pattern-detail__grid">
                <div><strong>朝代(时期)</strong><span>清代</span></div>
                <div><strong>公元纪年</strong><span>年代未详</span></div>
                <div><strong>纹样类别</strong><span>连续</span></div>
...
### 卷草纹 {: .pattern-seq-anchor }

<section class="pattern-detail pattern-detail--seq">
    <div class="pattern-detail__image">
        <img src="../../image/pattern/juan-cao-wen-qing.jpg" alt="卷草纹" />
    </div>
    <div class="pattern-detail__content">
        <div class="pattern-detail__top">
            <h2>卷草纹</h2>
        ...
        <article class="pattern-detail__info">
            ...
            <p class="pattern-detail__desc"><strong>图案介绍：</strong>卷草纹为清代常见的植物纹题材之一，常用于器物装饰、建筑彩绘或织绣图案。</p>
        </article>
...
<section class="pattern-detail pattern-detail--seq">
    <div class="pattern-detail__image">
        <img src="../../image/pattern/excel-row047-璎珞纹.png" alt="璎珞纹" />
    </div>
    <div class="pattern-detail__content">
        <div class="pattern-detail__top">
            <h2>璎珞纹</h2>
...
<section class="pattern-detail pattern-detail--seq">
    <div class="pattern-detail__image">
        <img src="../../image/pattern/excel-row048-福庆纹.png" alt="福庆纹" />
    </div>
    <div class="pattern-detail__content">
        <div class="pattern-detail__top">
            <h2>福庆纹</h2>
...
<section class="pattern-detail pattern-detail--seq">
    <div class="pattern-detail__image">
        <img src="../../image/pattern/excel-row049-古彩锦纹.png" alt="古彩锦纹" />
    </div>
    <div class="pattern-detail__content">
        <div class="pattern-detail__top">
            <h2>古彩锦纹</h2>
...
<section class="pattern-detail pattern-detail--seq">
    <div class="pattern-detail__image">
        <img src="../../image/pattern/excel-row052-如意纹.png" alt="如意纹" />
    </div>
    <div class="pattern-detail__content">
        <div class="pattern-detail__top">
            <h2>如意纹</h2>
