<div class="spirit-dialogue-page"></div>

<section class="library-head">
  <p class="section-kicker">AI SPIRIT DIALOGUE</p>
  <h2>灵境对话</h2>
  <p class="section-intro">每一件文物都有自己的灵魂与故事。选择一件器物，开启跨越千年的对话。</p>
</section>
...
<div class="dialogue-layout">
  <aside class="dialogue-selector-panel">
    ...
    <div class="dialogue-artifact-list">
      ...
      <div class="dialogue-artifact-item" data-artifact="ming" data-name="青花花卉纹瓷盘" data-sub="明代 · 大都会艺术博物馆藏" data-img="https://images.metmuseum.org/CRDImages/as/original/24_170_1_O1_sf.jpg" data-greeting="吾为明代青花花卉纹瓷盘，构图层次分明，花卉纹样细腻。若想了解明代审美与工艺，我可为你讲述。">
        <div class="dialogue-artifact-thumb">
          <img src="https://images.metmuseum.org/CRDImages/as/original/24_170_1_O1_sf.jpg" alt="青花花卉纹瓷盘" />
        </div>
        <div class="dialogue-artifact-meta">
          <strong>青花花卉纹瓷盘</strong>
          <span>明代 · 大都会艺术博物馆藏</span>
        </div>
      </div>
      <div class="dialogue-artifact-item" data-artifact="qing" data-name="冰裂纹开片釉瓷瓶" data-sub="清代 · 大都会艺术博物馆藏" data-img="https://images.metmuseum.org/CRDImages/as/original/LC-91_1_412_whs-003.jpg" data-greeting="吾为清代冰裂纹开片釉瓷瓶，釉面开片细密如冰裂，器型修长沉静。若你愿意，我可讲述我的诞生与流传。">
        <div class="dialogue-artifact-thumb">
          <img src="https://images.metmuseum.org/CRDImages/as/original/LC-91_1_412_whs-003.jpg" alt="冰裂纹开片釉瓷瓶" />
        </div>
        <div class="dialogue-artifact-meta">
          <strong>冰裂纹开片釉瓷瓶</strong>
          <span>清代 · 大都会艺术博物馆藏</span>
        </div>
      </div>
    </div>
  ...
  <div class="dialogue-chat">
    ...
    <div class="dialogue-input-area">
      <input type="text" class="dialogue-input" id="dialogue-input" placeholder="向文物提问 (Ask about its history, creation, or journey)..." />
      <button class="dialogue-send" id="dialogue-send">发送</button>
    </div>
  </div>
</div>

<section class="dialogue-tip-section">
  <div class="dialogue-tips">
    <div class="dialogue-tip">
      <span class="dialogue-tip-icon">🏺</span>
      <p>询问文物的制作工艺、历史背景或流传故事</p>
    </div>
    <div class="dialogue-tip">
      <span class="dialogue-tip-icon">🖌</span>
      <p>了解文物纹饰的文化含义与时代审美</p>
    </div>
    <div class="dialogue-tip">
      <span class="dialogue-tip-icon">🔬</span>
      <p>探索修复技术如何让破损文物重焕生机</p>
    </div>
  </div>
</section>
